...
class GuruController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepsek.guru.index')->with('success', 'Data Guru berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kepsek.guru.index')->with('success', 'Data guru berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kepsek.guru.index')->with('success', 'Guru dan User terkait berhasil dihapus.');
    }
