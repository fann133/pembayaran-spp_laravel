...
class BiayaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kepsek.biaya.index', [
            'biayaList' => $query->get(),
    ...
    {
        return view('kepsek.biaya.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepsek.biaya.index')->with('success', 'Biaya berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('kepsek.biaya.edit', compact('biaya'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kepsek.biaya.index')->with('success', 'Data Biaya berhasil diperbarui.');
    }
    ...
    public function destroy($id_biaya)
    {
        ...
        return redirect()->route('kepsek.biaya.index')
