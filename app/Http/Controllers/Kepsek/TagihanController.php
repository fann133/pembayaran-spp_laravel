...
class TagihanController extends Controller
{
    public function index()
    {
        ...
        $tagihan = Tagihan::with('siswa.kelasData', 'biaya')
                ...
                ->get();
        return view('kepsek.tagihan.index', compact('tagihan'));
    }
    ...
    public function create()
    {
        ...
        return view('kepsek.tagihan.create', compact('siswas', 'biayas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepsek.tagihan.index')->with('success', 'Tagihan berhasil ditambahkan.');
    }
    ...
    public function payment($id)
    {
        ...
        return view('kepsek.tagihan.payment', compact('tagihan'));
    }
    ...
    public function processPayment(Request $request, $id)
    {
        ...
        if ($dibayarSekarang > $tagihan->jumlah) {
            return redirect()->route('kepsek.tagihan.index')->with('error', 'Jumlah pembayaran melebihi sisa tagihan.');
        }
        ...
        if ($status == 'LUNAS') {
            ...
            return redirect()->route('kepsek.tagihan.index')->with('success', 'Pembayaran berhasil. Tagihan sudah lunas.');
        } else {
            ...
            return redirect()->route('kepsek.tagihan.index')->with('warning', 'Pembayaran berhasil. Tagihan belum lunas.');
        }                
    }
    ...
    public function print($id_tagihan)
    {
        ...
        $html = view('kepsek.tagihan.print', compact('tagihan'))->render();
    ...
    public function printAll(Request $request)
    {
        ...
        $html = view('kepsek.tagihan.print-pdf', compact('tagihan'))->render();
