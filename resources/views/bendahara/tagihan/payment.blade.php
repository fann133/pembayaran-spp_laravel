...
@section('title', $pengaturan->nama_aplikasi . ' | Pembayaran Tagihan')
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-7">
            <div class="card box2 p-4">
                ...
                <form action="{{ route('bendahara.tagihan.processPayment', $tagihan->id_tagihan) }}" method="POST">
                    @csrf
                ...
                <a href="{{ route('bendahara.tagihan.index') }}" class="btn btn-secondary w-100 mt-3">
