...
@section('title', $pengaturan->nama_aplikasi . ' | Ubah Biaya')
...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.biaya.index') }}">Biaya</a></li>
            ...
            <form action="{{ route('admin.biaya.update', $biaya->id_biaya) }}" method="POST">
                ...
                <div class="container d-flex flex-column col-12 col-md-5 justify-content-center">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" name="kode" class="form-control" value="{{ $biaya->kode }}">
                    </div>
                ...
                <div class="container d-flex flex-column col-12 justify-content-start">
                    <div class="d-flex mb-5 bg-gray-200">
                        <div class="mb-4 mt-4 text-center w-75">
                            ...
                            <a href="{{ route('admin.biaya.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                    </div>
                </div>
            </form>
