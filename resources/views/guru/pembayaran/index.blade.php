    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body border-bottom-primary">
              <form id="excelForm" method="POST" action="{{ route('guru.pembayaran.exportExcel') }}" style="display: none;">
                @csrf
                  @foreach ($pembayarans as $p)
                      <input type="checkbox" name="pembayaran_id[]" class="pembayaran-checkbox" value="{{ $p->id_pembayaran }}">
                  @endforeach
              </form>
              <form id="printForm" method="POST" action="{{ route('guru.pembayaran.printAll') }}" target="_blank">
                @csrf
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        nextBtn.addEventListener("click", function () {
            ...
            deleteForm.action = "/guru/pembayaran/" + pembayaranId;
